module DeviseTokenAuth::Concerns::SetUserByToken
    ...
    if @used_auth_by_token && !DeviseTokenAuth.change_headers_on_each_request
      ...
      @resource.with_lock do
        ...
        if @is_batch_request
          ...
          auth_header.delete(DeviseTokenAuth.headers_names[:"access-token"])
          auth_header.delete(DeviseTokenAuth.headers_names[:"expiry"])
  ...
  def is_batch_request?(user, client_id)
    ...
    Time.zone.parse(user.tokens[client_id]['updated_at']) > @request_started_at - DeviseTokenAuth.batch_request_buffer_throttle
  end
end
